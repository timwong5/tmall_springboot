...
public class ForeRESTController {
    ...
    /**
     * 将 buyoneAndAddCart放在了OrderItemService中 待测试
     *
     * @param pid
     * @param num
     * @param session
    ...
    /**
     * 3. 导致ForeRESTController.orderConfirmed()方法被调用
     * 3.1 获取参数oid
    ...
    /**
     * ForeRESTController.deleteOrder()
     * 1.1 获取参数oid
     * 1.2 根据oid获取订单对象o
     * 1.3 修改状态
     * 1.4 更新到数据库
     ...
     * 那么就使用这第一个产品的图片了。
     * （这里没有对订单里的每种产品都评价，因为复杂度就比较高了，初学者学起来太吃力，有可能就放弃学习了，
     * 所以考虑到学习的平滑性，就仅仅提供对第一个产品的评价）
     * 3.5 获取这个产品的评价集合
     * 3.6 为产品设置评价数量和销量
